...
$(document).on('ready', function () {
    ...
    /*Keyur script ends*/
    $('.homobile-menu li, .homobile-menu-2 li').on('click', function () {
        // $('.other-menu').addClass('hover_active');
    });

    $('.other-menu').on('mouseenter', function () {
        //$('.homobile-menu').attr('style', 'visibility: visible');
        $('.homobile-menu').animate({ '-moz-transform': 'translate3d(0, 84px, 0px)', '-webkit-transform': 'translate3d(0, 84px, 0px)', '-ms-transform': 'translate3d(0, 84px, 0px)', '-o-transform': 'translate3d(0, 84px, 0px)', 'transform': 'translate3d(0, 84px, 0px)' }, 'fast');
        setTimeout(function () {
            $('.homobile-menu').css('-moz-transform', 'translate3d(0, 0px, 0px)').css('-webkit-transform', 'translate3d(0, 84px, 0px)').css('-ms-transform', 'translate3d(0, 84px, 0px)').css('-o-transform', 'translate3d(0, 84px, 0px)').css('transform', 'translate3d(0, 84px, 0px)');
        }, 200);
    });

    $('.other-menu').on('mouseenter', function () {
        $('.homobile-menu').animate({ '-moz-transform': 'translate3d(0px, 0px, 0px)', '-webkit-transform': 'translate3d(0px, 0px, 0px)', '-ms-transform': 'translate3d(0px, 0px, 0px)', '-o-transform': 'translate3d(0px, 0px, 0px)', 'transform': 'translate3d(0px, 0px, 0px)', }, 'fast');
        $('.other-menu').addClass('hover_active');
        $('.other-menu a').addClass('hover_active selected');
        setTimeout(function () {
            $('.homobile-menu').css('-moz-transform', 'translate3d(0px, 0px, 0px)').css('-webkit-transform', 'translate3d(0px, 0px, 0px)').css('-ms-transform', 'translate3d(0px, 0px, 0px)').css('-o-transform', 'translate3d(0px, 0px, 0px)').css('transform', 'translate3d(0px, 0px, 0px)');
        }, 200);


    }).on('mouseleave', function () {

        $('.homobile-menu').animate({ '-moz-transform': 'translate3d(0px, -400px, 0px)', '-webkit-transform': 'translate3d(0px, -400px, 0px)', '-ms-transform': 'translate3d(0px, -400px, 0px)', '-o-transform': 'translate3d(0px, -400px, 0px)', 'transform': 'translate3d(0px, -400px, 0px)' }, 'fast');
        $('.other-menu').removeClass('hover_active');
        $('.other-menu a').removeClass('hover_active selected');
        setTimeout(function () {
            $('.homobile-menu').css('-moz-transform', 'translate3d(0px, -400px, 0px)').css('-webkit-transform', 'translate3d(0px, -400px, 0px)').css('-ms-transform', 'translate3d(0px, -400px, 0px)').css('-o-transform', 'translate3d(0px, -400px, 0px)').css('transform', 'translate3d(0px, -400px, 0px)');
        }, 200);
    });
    ...
    target.setDate(22 ); // Set no. of days from today
    ...
    if ($.find('#ife-wedding').length) {
        $('#ife-wedding').countdown({
            date: '04/22/2017 23:59:59',
            offset: +2.30,
            day: 'Day',
            days: 'Days'
        }, function () {
